...
class _MotorScanRow(QtWidgets.QWidget):
    ...
    def get(self):
        name = self._scanAxis.currentText()
...
class ScanWidget(QtWidgets.QWidget):
    ...
    def _start(self):
        ...
        self._scanner = Scanner(self._storage, self._list.get(), self._detectors[self._detectorsBox.currentText()], self._exposure.value(), self._nameBox.text, self._autosave, self._preStartFunc, self._postFinishFunc, mask)
