...
class Scanner(QtCore.QObject):
    ...
    def __init__(self, storage, scanlist, detector, exposure, fileName=None, autosave=True, preStartFunc=None, postFinishFunc=None, mask=None):
        """
    ...
    def start(self):
        ...
        if not self._autosave:
            self._storage.changeConnectState(self._detector, False)
